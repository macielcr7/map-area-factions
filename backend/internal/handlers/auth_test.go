...
func (m *MockUserRepository) GetUsers(page, limit int, search, role string) ([]models.User, int, error) {
	args := m.Called(page, limit, search, role)
...
func TestAuthHandler_Login_Success(t *testing.T) {
	...
	user := &models.User{
		...
		Role:     string(models.RoleCitizen),
		Active:   true,
	}
